<div class="card">
    ...
    <form class="form-horizontal" x-data="{}" wire:submit.prevent="create" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <div class="row mt-3" dir="@if(config('weirdo_panel.rtl_mode')) rtl @else ltr @endif">
                        ...
                        <div class="mt-3 ml-1">
                            ...
                            <div class="form-check d-flex justify-content-between w-100">
                                ...
                                <div class="@if(config('weirdo_panel.rtl_mode')) ml-1 @endif">
                                    <input type="checkbox"
                                    class="form-check-input" wire:model.live="selectedAll.{{$dashKey}}" onchange="selectAll(this, '{{$dashKey}}')">
                                </div>
