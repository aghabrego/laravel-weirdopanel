<div class="card" x-data="{ modalTokenIsOpen : false }" @name-modal-personal-access-token-is-open="modalTokenIsOpen = true">
    <div class="card-header p-0">
        ...
        <div class="px-2 mt-4">
            <ul class="breadcrumb mt-3 py-3 px-4 rounded">
                ...
                <li class="breadcrumb-item"><a href="@route(getRouteName().'.personalaccesstokens.lists')" class="text-decoration-none">{{ __(\Illuminate\Support\Str::plural('Personalaccesstoken')) }}</a></li>
    ...
    <form class="form-horizontal" wire:submit.prevent="create" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a href="@route(getRouteName().'.personalaccesstokens.lists')" class="btn btn-default float-left">{{ __('Cancel') }}</a>
        </div>
    </form>
