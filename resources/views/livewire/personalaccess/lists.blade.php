                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" @if(config('weirdo_panel.lazy_mode')) wire:model.blur="search" @else wire:model.live="search" @endif placeholder="{{ __('Search') }}" value="{{ request('search') }}">
