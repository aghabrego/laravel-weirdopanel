...
use WeirdoPanel\Support\Contract\BaseFacade;
 ...
 * @method static array makeOrganization($id, $organizations = [])
 * @see \WeirdoPanel\Support\Organization\OrganizationProvider
 */
class OrganizationFacade extends BaseFacade
{
    //
}
