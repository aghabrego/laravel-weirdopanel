...
namespace WeirdoPanel\Parsers;

use Illuminate\Support\Str;
use WeirdoPanel\Parsers\HTMLInputs\InputList;
use WeirdoPanel\Parsers\Fields\Field;
use WeirdoPanel\Parsers\HTMLInputs\BaseInput;
use WeirdoPanel\Concerns\Translatable;
use WeirdoPanel\Parsers\HTMLInputs\File;
...
class StubParser
{
    ...
    public function parseProperties()
    {
        ...
        if(in_array($this->inputName, $fields)){
            $this->error("El nombre del modelo no debe ser igual a los nombres de las columnas, corríjalo y vuelva a ejecutar el comando con el indicador -f flag");
            die;
        }
